...
(cl:defclass <fibonacciActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type chores-msg:fibonacciGoal
    :initform (cl:make-instance 'chores-msg:fibonacciGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <fibonacciActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'fibonacciActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chores-msg:<fibonacciActionGoal> is deprecated: use chores-msg:fibonacciActionGoal instead.")))
