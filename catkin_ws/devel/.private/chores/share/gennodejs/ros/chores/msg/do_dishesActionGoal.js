...
let do_dishesGoal = require('./do_dishesGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class do_dishesActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = do_dishesGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new do_dishesActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = do_dishesGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new do_dishesGoal()
    }
...
module.exports = do_dishesActionGoal;
