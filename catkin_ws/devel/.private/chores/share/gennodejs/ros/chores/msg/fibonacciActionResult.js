...
class fibonacciActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = fibonacciResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += fibonacciResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new fibonacciActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = fibonacciResult.Resolve(msg.result)
    }
    else {
      resolved.result = new fibonacciResult()
    }
...
module.exports = fibonacciActionResult;
