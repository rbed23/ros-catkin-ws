...
let do_dishesFeedback = require('./do_dishesFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class do_dishesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new do_dishesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = do_dishesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new do_dishesActionFeedback(null);
    ...
    data.feedback = do_dishesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new do_dishesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = do_dishesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new do_dishesFeedback()
    }
...
module.exports = do_dishesActionFeedback;
